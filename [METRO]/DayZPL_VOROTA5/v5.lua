...
function createGate ()
	gatePolice = createObject ( 2004, 2116.2998046875, -1878.099609375, -50.1,0,0,71.993408203125 ) -- де ворота мають бути 
end
...
--if getTeamName ( getPlayerTeam ( thePlayer ) ) ==''then
	moveObject ( gatePolice, 3000, 2115.5, -1880.8000488281, -50.1 ) -- Де ворота мають бути коли відкриті
--end
end
...
function movingBackPolice ()
	moveObject ( gatePolice, 2000, 2116.2998046875, -1878.099609375, -50.1) -- Де ворота будуть коли закриті
end
