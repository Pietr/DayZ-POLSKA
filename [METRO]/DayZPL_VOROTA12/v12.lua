...
function createGate ()
	gatePolice = createObject ( 2004, 1713.4000244141, -1705.8000488281, -50.1,0,0,238.73229980469 ) -- де ворота мають бути 
end
...
--if getTeamName ( getPlayerTeam ( thePlayer ) ) ==''then
	moveObject ( gatePolice, 3000, 1714.9000244141, -1703.4000244141, -50.1 ) -- Де ворота мають бути коли відкриті
--end
end
...
function movingBackPolice ()
	moveObject ( gatePolice, 2000, 1713.4000244141, -1705.8000488281, -50.1) -- Де ворота будуть коли закриті
end
