...
function createGate ()
	gatePolice = createObject ( 2004, 2283.1000976563, -2027.6999511719, -50.1,0,0,239.23480224609 ) -- де ворота мають бути 
end
...
--if getTeamName ( getPlayerTeam ( thePlayer ) ) ==''then
	moveObject ( gatePolice, 3000, 2284.3999023438, -2025.1999511719, -50.1 ) -- Де ворота мають бути коли відкриті
--end
end
...
function movingBackPolice ()
	moveObject ( gatePolice, 2000, 2283.1000976563, -2027.6999511719, -50.1) -- Де ворота будуть коли закриті
end
