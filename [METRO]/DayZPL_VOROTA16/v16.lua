...
function createGate ()
	gatePolice = createObject ( 2004, 2283.5, -2035, -50.1,0,0,58.982788085938 ) -- де ворота мають бути 
end
...
--if getTeamName ( getPlayerTeam ( thePlayer ) ) ==''then
	moveObject ( gatePolice, 3000, 2282, -2037.4000244141, -50.1 ) -- Де ворота мають бути коли відкриті
--end
end
...
function movingBackPolice ()
	moveObject ( gatePolice, 2000, 2283.5, -2035, -50.1) -- Де ворота будуть коли закриті
end
