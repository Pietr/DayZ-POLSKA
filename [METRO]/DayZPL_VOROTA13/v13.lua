...
function createGate ()
	gatePolice = createObject ( 2004, 2280, -2032.9000244141, -50.1,0,0,239.23278808594 ) -- де ворота мають бути 
end
...
--if getTeamName ( getPlayerTeam ( thePlayer ) ) ==''then
	moveObject ( gatePolice, 3000, 2278.5, -2035.4000244141, -50.1 ) -- Де ворота мають бути коли відкриті
--end
end
...
function movingBackPolice ()
	moveObject ( gatePolice, 2000, 2280, -2032.9000244141, -50.1) -- Де ворота будуть коли закриті
end
