checkGateMarker = createMarker ( 2750.3000488281, 2720.6000976563, 17.39999961853, "cylinder", 22, 0, 0, 0, 0 ) -- місце маркера
...
function createGate ()
	gatePolice = createObject ( 2076, 2749.7998046875, 2720.6005859375, 24,0,90,0 ) -- де ворота мають бути 
end
...
--if getTeamName ( getPlayerTeam ( thePlayer ) ) ==''then
	moveObject ( gatePolice, 3000, 2749.7998046875, 2720.6005859375, 7 ) -- Де ворота мають бути коли відкриті
--end
end
...
function movingBackPolice ()
	moveObject ( gatePolice, 2000, 2749.7998046875, 2720.6005859375, 24) -- Де ворота будуть коли закриті
end
