...
function(hitElement, matchingDimension)
	if (getElementID (source) == "greenzoneColshape") then
		...
		if (isElement(hitElement)) and (getElementType (hitElement) == "player") then
			outputChatBox("Wszedłeś do GreenZone", hitElement)
			...
			setElementData(hitElement, "createObject", false)
		else
...
function(leaveElement, matchingDimension)
	if (getElementID (source) == "greenzoneColshape") then
		...
		if (getElementType (leaveElement) == "player") then
            outputChatBox("Opuściłeś GreenZone", leaveElement)
			...
			setElementData(leaveElement, "createObject", true)
